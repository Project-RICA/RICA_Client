...
#### Recent changes
Nowadays, we are considering how to distribute RICA to people.\
We're expecting that the policy about open source will be decided when we inform the result of that consideration in here.
...
- ### 📝 Realtime Learning System (RLS)
  Realtime learning is the most important part of RICA becuase comment(conversation) types are being changed rapidly, and continuously.\
...
This part shows you where RICA can exert its power, and contains the guide of the initial setting per each place.
  ...
  - ### 🎮 Discord
    _RICA bot will be developed after the first version of RICA for YouTube successfully works in there._\
    _And also RICA needs DB before analyzing the various chat in Discord channel. Normal talks are much complex to do it._\
    _Comming Soon!_
...
- __Some data are generated by Team RICA.__
